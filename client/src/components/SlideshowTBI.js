      ...
      <div className={`slideshow-container${activeIndex !== null ? ' active' : ''}`}>
        <div className="slideshow">
          ...
          {slides.map((slide, index) => (
            ...
            >
              <iframe
                src="https://onedrive.live.com/embed?resid=8231C5B016E26FE4%21938&amp;authkey=!ACFwahUv7CxzGqo&amp;em=2&amp;wdAr=1.7777777777777777"
                title={`Slide ${index + 1}`}
                allowFullScreen
              ></iframe>
            </div>
